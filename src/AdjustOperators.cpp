...
bool AdjustOperators::runOnModule(Module &module) {
  errs() << "AdjustOperators::runOnModule:\n";
...
#ifdef DEBUG
  errs() << "AdjustOperators::changeBinaryOperator:\n";
  errs() << "oldTarget: ";
  oldTarget->dump();
  errs() << "operand 0: ";
  oldTarget->getOperand(0)->dump();
  errs() << "operand 1: ";
  oldTarget->getOperand(1)->dump();
#endif
